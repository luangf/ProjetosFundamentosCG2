...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Ola 3D - Luan Gomes!", nullptr, nullptr);
...
int setupGeometry()
{
	...
	GLfloat vertices[] = {
		...
		// Face 3 - superior - Azul
		-0.5, 0.5, -0.5, 0.0, 0.0, 1.0, // V1
		...
		// Face 4 - inferior - Amarelo
		-0.5, -0.5,  0.5, 1.0, 1.0, 0.0, // V7
		...
		-0.5, -0.5,  0.5, 0.0, 1.0, 1.0, // V7
		-0.5,  0.5, -0.5, 0.0, 1.0, 1.0, // V1
		-0.5, -0.5, -0.5, 0.0, 1.0, 1.0, // V0

		// Face 6 - direita - Magenta
